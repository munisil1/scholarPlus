...
package com.example.mapsforteam13;
...
//                    .build();
     ...
     */
    public void onGoNormal(View view) {
        System.out.println("inside onGoNormal");
        if (!checkReady()) {
            return;
        }
        System.out.println("just before set Type");
     ...
     */
    public void onGoHybrid(View view) {

        mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);
    }

    public void onGoSatellite(View view) {

        mMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
    }
    public void onGoTerrain(View view) {
